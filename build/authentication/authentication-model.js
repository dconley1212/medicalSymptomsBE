...
function getUserByID(id) {
    return (0, db_config_1.dbConfig)("users").where("id", id);
}
exports.getUserByID = getUserByID;
function getUserByFilter(filter) {
    return (0, db_config_1.dbConfig)("users").where("username", filter.username);
}
exports.getUserByFilter = getUserByFilter;
function insertUser(user) {
    const newUser = (0, db_config_1.dbConfig)("users").insert(user);
    console.log(newUser);
}
